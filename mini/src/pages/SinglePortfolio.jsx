...
function SinglePortfolio() {
  return (
    <>
        ...
        <Breadcrumbs page="Single Portfolio" title="Mini's Single Portfolio" />
        {/* Breadcrumb area end */}
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="portfolio-thumbnail-wrapper">
                                <div className="single-project-thumb">
                                    <a href="img/portfolio/single-portfolio/1.jpg"><img src="/assets/img/portfolio/single-portfolio/1.jpg" alt=""/></a>
                                </div>
                                <div className="single-project-thumb">
                                    <a href="img/portfolio/single-portfolio/2.jpg"><img src="/assets/img/portfolio/single-portfolio/2.jpg" alt=""/></a>
                                </div>
                                <div className="single-project-thumb">
                                    <a href="img/portfolio/single-portfolio/3.jpg"><img src="/assets/img/portfolio/single-portfolio/3.jpg" alt=""/></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-9 col-md-8">
                            <div className="single-project-description">
                                <h2 className="single-project-title">simple portfolio title.</h2>
